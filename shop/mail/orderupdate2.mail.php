       ...
       <!-- 주문자 정보 -->
        <table width="95%" align="center" cellpadding="0" cellspacing="0">
        	<tr>
                ...
                <td style="color:#A26217; text-align:right;">상세한 내용은 주문서 조회 화면에서 확인하실 수 있습니다.  [<a href="<?php echo G4_SHOP_URL.'/orderinquiry.php'; ?>">바로가기</a>]</td>
            </tr>
            <tr>
                <td colspan=2>
                    <table width="100%" cellpadding="4" cellspacing="0">
        ...
        <tr>
            ...
            <td style="color:#A26217; text-align:right;">배송지를 변경하실 고객님은 <B><?php echo  $default['de_admin_company_tel']; ?></B>로 연락주시기 바랍니다.</td></tr>
        <tr>
            <td colspan=2>
                <table width="100%" cellpadding="4" cellspacing="0">
                <col width=110>
