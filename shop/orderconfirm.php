...
// 장바구니가 비어있는가?
$uq_id = get_session('ss_temp_uniqid');
$sw_direct = get_session('ss_temp_direct');
if (get_cart_count($uq_id, $sw_direct) == 0)// 장바구니에 담기
...
if (file_exists("./settle_{$default['de_card_pg']}.inc.php"))
{
    ...
    {
        echo "<p align=center><a href='./orderinquiryview.php?od_id={$od['od_id']}&uq_id={$od['uq_id']}'><img src='{$g4['shop_img_path']}/btn_order_end.gif' border=0></a>";
    }
    else
    {
        if ($settle_case == '신용카드')
