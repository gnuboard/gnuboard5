...
<ul class="btn_top top btn_bo_user"> 
    ...
    <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b03 btn"><i class="fa fa-pencil" aria-hidden="true" title="글쓰기"></i><span class="sound_only">글쓰기</a></li><?php } ?>
