        ...
        <article id="memo_view_contents">
            ...
            <div id="memo_view_ul">
                ...
                <div class="memo_li memo_name">
					<a href="<?php echo $list[$i]['view_href'] ?>"><?php echo $list[$i]['mb_nick'] ?></a></span>
					<br>
					<span class="memo_view_date"><span class="sound_only"><?php echo $kind_date ?>시간</span><i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo $memo['me_send_datetime'] ?></span>
				</div>	
            </div>
            <p>
