...
if (G5_IS_MOBILE) {
    include_once(G5_THEME_MSUBSCRIPTION_PATH.'/index.php');
    return;
}

if(! defined('_INDEX_')) define('_INDEX_', TRUE);

include_once(G5_THEME_SUBSCRIPTION_PATH.'/subscription.head.php');
?>
...
<?php
include_once(G5_THEME_SUBSCRIPTION_PATH.'/shop.tail.php');