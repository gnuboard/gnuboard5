...
<article id="bo_v">
    <div class="bo_v_wr">
        ...
        <section id="bo_v_info">
            <h2>페이지 정보</h2>
            <span class="sound_only">작성자</span><strong><span class="profile_img"><img src="http://sora.gnutest.com/g5/theme/basic/img/no_profile.gif" alt="프로필이미지" width="20" height="20"></span> <?php echo $view['name'] ?></strong>
