    ...
    <div class="list_01">
        <ul>
            ...
            <li class="bo_li<?php if ($is_checkbox) echo ' bo_adm'; ?>">
                ...
                <div class="li_info">
                    <span><span class="profile_img"><img src="http://sora.gnutest.com/g5/theme/basic/img/no_profile.gif" alt="프로필이미지" width="20" height="20"></span> <?php echo $list[$i]['name']; ?></span>
