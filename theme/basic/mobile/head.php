...
<header id="hd">
    ...
    <div id="hd_wrapper">
        ...
        <div id="logo">
            <a href="<?php echo G5_URL ?>"><img src="<?php echo G5_IMG_URL ?>/m_logo.png" alt="<?php echo $config['cf_title']; ?>"  height="15"></a>
        </div>
        ...
        <button type="button" id="user_btn" class="hd_opener">사용자메뉴</button>
