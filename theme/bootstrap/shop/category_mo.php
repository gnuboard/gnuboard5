...
<div id="category_mo" class="menu">
    <div class="menu_wr">
        <?php echo outlogin('theme/shop_basic_mo'); // 외부 로그인 ?>
...
jQuery(function ($){
  ...
  $( document ).ready( function() {
            ...
            function catetory_menu_fn( is_open ){
                var $cagegory = $("#category_mo");

                if( is_open ){
                    $cagegory.addClass("active");
                    $("html").addClass("is_hidden");
                } else {
                    $cagegory.removeClass("active");
