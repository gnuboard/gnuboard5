...
<!-- 쪽지 목록 시작 { -->
<div id="memo_list" class="new_win min-h-screen dark:bg-zinc-900">
    <h1 id="win_title" class="dark:!bg-zinc-800 dark:!text-white">
    	<?php echo $g5['title'] ?>
    	<div class="win_total dark:bg-zinc-900">전체 <?php echo $kind_title ?>쪽지 <?php echo $total_count ?>통<br></div>
    </h1>
    <div class="new_win_con2">
        ...
        <div class="memo_list dark:!border-mainborder">
            <ul>
	            <?php
                ...
                ?>
	            <li class="<?php echo $readed; ?> dark:!bg-zinc-800 dark:border-mainborder">
	                ...
	                <div class="memo_li memo_name">
						...
						<div class="memo_preview dark:text-white">
	            ...
	            <?php } ?>
	            <?php if ($i==0) { echo '<li class="empty_table dark:bg-zinc-900 dark:!border-mainborder dark:text-white">자료가 없습니다.</li>'; }  ?>
            </ul>
        </div>
