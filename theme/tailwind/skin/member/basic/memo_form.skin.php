...
<!-- 쪽지 보내기 시작 { -->
<div id="memo_write" class="new_win min-h-screen dark:bg-zinc-900">
    <h1 id="win_title" class="dark:!bg-zinc-800 dark:!text-white"><i class="fa fa-envelope-o" aria-hidden="true"></i> 쪽지 보내기</h1>
    <div class="new_win_con2">
        ...
        <div class="form_01 dark:!border-mainborder">
            <h2 class="sound_only">쪽지쓰기</h2>
            <ul>
                <li>
                    <label for="me_recv_mb_id" class="sound_only">받는 회원아이디<strong>필수</strong></label>
                    
                    <input type="text" name="me_recv_mb_id" value="<?php echo $me_recv_mb_id; ?>" id="me_recv_mb_id" required class="frm_input full_input required dark:bg-zinc-800 dark:border-mainborder dark:text-white" size="47" placeholder="받는 회원아이디">
                ...
                <li>
                    ...
                    <textarea name="me_memo" id="me_memo" required class="required dark:bg-zinc-800 dark:border-mainborder dark:text-white"><?php echo $content ?></textarea>
                </li>
                <li>
