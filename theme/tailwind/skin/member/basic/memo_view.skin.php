...
<!-- 쪽지보기 시작 { -->
<div id="memo_view" class="new_win min-h-screen dark:bg-zinc-900">
    ...
    <div class="new_win_con2">
        ...
        <article id="memo_view_contents" class="dark:!border-mainborder">
            <header>
                <h2>쪽지 내용</h2>
            </header>
            <div id="memo_view_ul">
                <div class="memo_view_li memo_view_name">
                	<ul class="memo_from dark:bg-zinc-800 dark:border-mainborder">
                		<li class="memo_profile">
				            <?php echo get_member_profile_img($mb['mb_id']); ?>
				        </li>
						<li class="memo_view_nick dark:text-white"><?php echo $nick ?></li>
            ...
            <p class="dark:!bg-zinc-800 dark:text-white">
