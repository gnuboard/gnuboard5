...
<!-- 로그인 후 아웃로그인 시작 { -->
<section id="ol_after" class="ol relative border border-solid border-gray-200 rounded mb-3.5">
    <header id="ol_after_hd" class="relative h-20 p-2.5 pl-20">
        ...
        <a href="<?php echo G5_BBS_URL ?>/member_confirm.php?url=register_form.php" id="ol_after_info" title="정보수정" class="inline-block h-7 leading-6 border border-solid border-gray-300 text-blue-500 rounded py-0.5 px-1">정보수정</a>
    ...
    <ul id="ol_after_private">
    	<li class="group relative text-left hover:bg-slate-100 hover:border-l-2 border-l-2 border-transparent hover:border-blue-500">
            <a href="<?php echo G5_BBS_URL ?>/point.php" target="_blank" id="ol_after_pt" class="win_point block text-slate-800 leading-4 p-2.5 pl-5 group-hover:text-blue-500">
        ...
        <li class="group relative text-left hover:bg-slate-100 hover:border-l-2 border-l-2 border-transparent hover:border-blue-500">
            <a href="<?php echo G5_BBS_URL ?>/memo.php" target="_blank" id="ol_after_memo" class="win_memo block text-slate-800 leading-4 p-2.5 pl-5">
        ...
        <li class="group relative text-left hover:bg-slate-100 hover:border-l-2 border-l-2 border-transparent hover:border-blue-500">
            <a href="<?php echo G5_BBS_URL ?>/scrap.php" target="_blank" id="ol_after_scrap" class="win_scrap block text-slate-800 leading-4 p-2.5 pl-5">
    ...
    <footer>
    	<a href="<?php echo G5_BBS_URL ?>/logout.php" id="ol_after_logout" class="block text-center font-bold py-3.5 text-gray-400 border-t border-gray-200 hover:text-blue-500"><i class="fa fa-sign-out" aria-hidden="true"></i> 로그아웃</a>
    </footer>
</section>
