...
<div class="lat relative bg-white mb-5 dark:bg-zinc-900">
    ...
    <?php for ($i=0; $i<$list_count; $i++) {  ?>
        <li class="basic_li relative border-b border-solid border-gray-200 mb-2.5 dark:border-mainborder">
            <?php
            if ($list[$i]['icon_secret']) echo "<i class=\"fa fa-lock\" aria-hidden=\"true\"></i><span class=\"sound_only\">비밀글</span> ";

            echo "<a href=\"".get_pretty_url($bo_table, $list[$i]['wr_id'])."\" class=\"font-bold text-sm leading-5 align-middle hover:text-blue-500 dark:text-white\"> ";
            if ($list[$i]['is_notice'])
