    ...
    <section id="bo_v_info">
        ...
        <div class="profile_info">
        	<div class="profile_info_ct">
        		<span class="sound_only">작성자</span> <strong><div class="pf_img"><?php echo get_member_profile_img($view['mb_id']) ?></div><?php echo $view['name'] ?><?php if ($is_ip_view) { echo "&nbsp;($ip)"; } ?></strong><br>
