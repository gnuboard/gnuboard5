...
<aside id="sbsk" class="sbsk">
    ...
    <form name="skin_frmcartlist" id="skin_sod_bsk_list" method="post" action="<?php echo G5_SUBSCRIPTION_URL.'/cartupdate.php'; ?>">
    <ul>
    <?php
    ...
    foreach($cart_datas as $row)
    {
        ...
        // 이미지로 할 경우
        $it_img = get_subscription_it_image($row['it_id'], 65, 65, true);
		echo '<div class="prd_img">'.$it_img.'</div>';
		echo '<div class="prd_cnt">';
        echo '<a href="'.G5_SUBSCRIPTION_URL.'/cart.php" class="prd_name">'.$it_name.'</a>';
