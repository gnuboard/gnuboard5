...
<div id="bo_gall" style="width:<?php echo $width; ?>">
    ...
    <ul id="gall_ul">
        <?php for ($i=0; $i<count($list); $i++) {
         ...
         ?>
        <li class="gall_li <?php if ($wr_id == $list[$i]['wr_id']) { ?>gall_now<?php } ?>" style="<?php echo $style ?>width:<?php echo $board['bo_gallery_width']+2 ?>px">
            <div class="gall_chk">
            <?php if ($is_checkbox) { ?>
            ...
            <div class="gall_con">
                ...
                <div class="gall_name">
                    <span class="sound_only">작성자 </span><span class="profile_img"><img src="<?php echo G5_IMG_URL ;?>/no_profile.gif" alt="프로필이미지" width="20" height="20"></span><?php echo $list[$i]['name'] ?>
                </div>
                <div class="gall_info">
