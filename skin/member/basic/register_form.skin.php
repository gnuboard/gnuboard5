...
<tr>
    ...
    <td>
        ...
        <input type="text" id="reg_mb_name" name="mb_name" value="<?=$member['mb_name']?>" <?=$required?> <? if ($config['cf_kcpcert_use']||$w=='u') echo 'readonly'; ?> class="frm_input nospace <?=$required?> <?=$readonly?>" size="10">
    </td>
</tr>
<? if ($req_nick) { ?>
<tr>
