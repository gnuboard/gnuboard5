...
<div id="memo_write" class="new_win">
    ...
    <div class="new_win_con">
        ...
        <div class="form_01">
            ...
            <ul>
                <li>
                    <label for="me_recv_mb_nicks" class="sound_only">받는 회원닉네임<strong>필수</strong></label>
                    
                    <input type="text" name="me_recv_mb_nicks" value="<?php echo $me_recv_mb_nicks; ?>" id="me_recv_mb_nicks" required class="frm_input full_input required" size="47" placeholder="받는 회원닉네임">
