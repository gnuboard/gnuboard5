        ...
        <li class="gall_li <?php if ($wr_id == $list[$i]['wr_id']) { ?>gall_now<?php } ?>">
            <div class="gall_li_wr">
                ...
                <div class="gall_text_href">
                    ...
                    ?>
                    <span class="profile_img"><span class="sound_only">작성자 </span><img src="<?php echo G5_IMG_URL ;?>/no_profile.gif" alt="프로필이미지" width="20" height="20"> <?php echo $list[$i]['name'] ?></span> 
                    <div class="gall_info">
