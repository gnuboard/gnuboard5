...
<form name="pay_form" method="post" action="<?php echo G5_MSUBSCRIPTION_URL; ?>/kcp/subscription_approval_form.php">
    <input type="hidden" name="ordr_idxx"      value="<?php echo $od_id; ?>">            <!-- 주문번호           -->
    <input type="hidden" name="good_mny"       value="<?php echo $tot_price ?>">             <!-- 휴대폰 결제금액    -->
    <input type="hidden" name="good_name"      value="<?php echo $goods; ?>">            <!-- 상품명             -->
