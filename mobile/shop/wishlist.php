...
<div id="sod_ws">
    ...
    <tr>
        ...
        <td><a href="<?php echo G4_MSHOP_URL; ?>/item.php?it_id=<?php echo $row['it_id']; ?>"><?php echo stripslashes($row['it_name']); ?></a></td>
        <td class="td_datetime"><?php echo $row['wi_time']; ?></td>
        <td class="td_smallmng"><a href="<?php echo G4_MSHOP_URL; ?>/wishupdate.php?w=d&amp;wi_id=<?php echo $row['wi_id']; ?>">삭제</a></td>
    </tr>
    <?php
    }
