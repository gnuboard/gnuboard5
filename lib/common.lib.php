...
// auto convert charset function create
function auto_convert_charset($str, $convert_charset) {
    if(function_exists('mb_detect_encoding') ) {
        $encode_array = array('UTF-8', 'ASCII', 'EUC-KR',
        ...
        if(!in_array(strtoupper($convert_charset), $encode_array)) die("Not found convert charset");

        return convert_charset(mb_detect_encoding($str, $encode_array), strtoupper($convert_charset), $str);
    } else {
        die("Not found 'mbstring' library in server.");
    }
}
