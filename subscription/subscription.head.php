...
if (defined('G5_THEME_PATH')) {
    require_once G5_THEME_SUBSCRIPTION_PATH.'/subscription.head.php';
...
<div id="hd">
	...
	<div id="tnb">
    	<div class="inner">
    		...
    		<ul id="hd_define">
    			...
    			<li class="active"><a href="<?php echo G5_SUBSCRIPTION_URL; ?>/">쇼핑몰</a></li>
    		</ul>
            <?php } ?>
			<ul id="hd_qnb">
	            ...
	            <li><a href="<?php echo G5_SUBSCRIPTION_URL; ?>/personalpay.php">개인결제</a></li>
	            <li><a href="<?php echo G5_SUBSCRIPTION_URL; ?>/itemuselist.php">사용후기</a></li> 
	            <li><a href="<?php echo G5_SUBSCRIPTION_URL; ?>/itemqalist.php">상품문의</a></li>
	        </ul>
		</div>
	</div>
    <div id="hd_wrapper">
        <div id="logo">
        	<a href="<?php echo G5_SUBSCRIPTION_URL; ?>/"><img src="<?php echo G5_DATA_URL; ?>/common/logo_img" alt="<?php echo $config['cf_title']; ?>"></a>
        </div>
		
		<div class="hd_sch_wr">
	        <fieldset id="hd_sch">
	            <legend>쇼핑몰 전체검색</legend>
	            <form name="frmsearch1" action="<?php echo G5_SUBSCRIPTION_URL; ?>/search.php" onsubmit="return search_submit(this);">
        ...
        <ul class="hd_login">        
			...
			<li class="shop_cart"><a href="<?php echo G5_SUBSCRIPTION_URL; ?>/cart.php"><i class="fa fa-shopping-cart" aria-hidden="true"></i><span class="sound_only">장바구니</span><span class="count"><?php echo get_boxcart_datas_count(); ?></span></a></li>
            <?php } else { ?>
    ...
    <div id="hd_menu">
		...
		<?php include_once G5_SUBSCRIPTION_PATH.'/category.php'; // 분류?>
		<ul class="hd_menu">
...
<div id="side_menu">
    ...
    <div id="tabs_con">
	    <div class="side_mn_wr1 qk_con">
	    	<div class="qk_con_wr">
		        ...
		        <ul class="side_tnb">
		            ...
		            <?php } ?>
					<li><a href="<?php echo G5_SUBSCRIPTION_URL; ?>/subscription_list.php">구독내역</a></li>
					<li><a href="<?php echo G5_BBS_URL; ?>/faq.php">FAQ</a></li>
		            <li><a href="<?php echo G5_BBS_URL; ?>/qalist.php">1:1문의</a></li>
	    ...
	    <div class="side_mn_wr3 qk_con">
	    	<div class="qk_con_wr">
	        	<?php // include_once(G5_SUBSCRIPTION_SKIN_PATH.'/boxcart.skin.php'); // 장바구니?>
	    		<button type="button" class="con_close"><i class="fa fa-times-circle" aria-hidden="true"></i><span class="sound_only">장바구니 닫기</span></button>
	    	</div>
	    </div>
	    <div class="side_mn_wr4 qk_con">
	    	<div class="qk_con_wr">
	        	<?php // include_once(G5_SUBSCRIPTION_SKIN_PATH.'/boxwish.skin.php'); // 위시리스트?>
...
<div id="wrapper" class="<?php echo implode(' ', $wrapper_class); ?>">
    ...
    <div id="container">
        ...
        <div id="aside">
            <?php // include_once(G5_SUBSCRIPTION_SKIN_PATH.'/boxcategory.skin.php'); // 상품분류?>
...
if (defined('IS_SUBSCRIPTION_SEARCH') && IS_SUBSCRIPTION_SEARCH) {
