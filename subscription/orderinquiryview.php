...
if( isset($_GET['ini_noti']) && !isset($_GET['uid']) ){
    goto_url(G5_SUBSCRIPTION_URL.'/orderinquiry.php');
}
...
if (!$is_member) {
    if (get_session('ss_orderview_uid') != $_GET['uid']) {
        // alert("직접 링크로는 주문서 조회가 불가합니다.\\n\\n주문조회 화면을 통하여 조회하시기 바랍니다.", G5_G5_SUBSCRIPTION__URL);
    }
}
        ...
        */
        ...
        <div class="tbl_head03 tbl_wrap">
            ...
            <tr>
                ...
                <td headers="th_itname" colspan="7" class="td_bdno"><a href="<?php echo subscription_item_url($row['it_id']); ?>"><?php echo $row['it_name']; ?></a></td>
            </tr>
            <?php } ?>
            <tr>
