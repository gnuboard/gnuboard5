...
<head>
<meta charset="utf-8">
<title><?php echo $config['cf_title']; ?> - 정기결제 db 쓰기 실패 메일</title>
</head>
...
<div style="margin:30px auto;width:600px;border:10px solid #f7f7f7">
    <div style="border:1px solid #dedede">
        <h1 style="margin:0 0 20px;padding:30px 30px 20px;background:#f7f7f7;color:#555;font-size:1.4em">
            <?php echo $config['cf_title'];?> - 정기결제 db 쓰기에 실패 했습니다.
        </h1>
        ...
        <a href="<?php echo G5_ADMIN_URL.'/subscription_admin/orderform.php?od_id='.$od_id; ?>" target="_blank" style="<?php echo $ft_a_st; ?>">관리자 모드에서 주문 확인</a>
