                ...
                <ul>
                    ...
                    ?>
                        ...
                        <li>
                            ...
                            <a href="./mycard_update.php?w=d&amp;ci_id=<?php echo $row['ci_id']; ?>" class="wish_del" onclick="return confirm('정말 삭제하시겠습니까?\n삭제시 해당 카드로 진행중인 정기구독 주문들은 종료됩니다.');"><i class="fa fa-trash" aria-hidden="true"></i><span class="sound_only">삭제</span></a>
                        </li>
