...
// $cart_items = sql_bind_select_array($g5['g5_subscription_cart_table'], array('od_id' => $cart_id, 'it_id' => $it_id), array('orderBy' => 'io_type asc, ct_id', 'orderType' => 'asc'));
...
// 판매가격
$sql2 = " select ct_price, it_name, ct_send_cost from {$g5['g5_subscription_cart_table']} where od_id = '$cart_id' and it_id = '$it_id' order by ct_id asc limit 1 ";
$row2 = sql_fetch($sql2);
...
<h2>상품옵션수정</h2>
<!-- 장바구니 옵션 시작 { -->
<form name="foption" method="post" action="<?php echo G5_SUBSCRIPTION_URL; ?>/cartupdate.php" onsubmit="return formcheck(this);">
