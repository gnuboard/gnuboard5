...
$it = sql_bind_select_fetch($g5['g5_shop_item_table'], '*', array('it_id' => $it_id, 'it_use' => 1, 'it_class_num' => array('>=' => 1)));
...
$row2 = sql_bind_select_fetch($g5['g5_subscription_cart_table'], 'ct_price, it_name, ct_send_cost', array('od_id' => $cart_id, 'it_id' => $it_id), array('orderBy' => 'ct_id', 'orderType' => 'asc', 'limit' => 1));
...
<div id="sit_sel_option">
    ...
    <ul id="sit_opt_added">
        ...
        <li class="sit_<?php echo $cls; ?>_list">
            <input type="hidden" name="io_type[<?php echo $it['it_id']; ?>][]" value="<?php echo get_text($row['io_type']); ?>">
            <input type="hidden" name="io_id[<?php echo $it['it_id']; ?>][]" value="<?php echo get_text($row['io_id']); ?>">
            <input type="hidden" name="io_value[<?php echo $it['it_id']; ?>][]" value="<?php echo get_text($row['ct_option']); ?>">
