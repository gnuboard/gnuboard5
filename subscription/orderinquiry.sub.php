...
if(defined('G5_THEME_SUBSCRIPTION_PATH')) {
    $theme_inquiry_file = G5_THEME_SUBSCRIPTION_PATH.'/orderinquiry.sub.php';
...
<div class="tbl_head03 tbl_wrap">
    ...
    */
    ...
    $result = sql_bind_select($g5['g5_subscription_order_table'], '*', array('mb_id'=>$member['mb_id']), array('orderBy'=>'od_id', 'orderType' => 'desc', 'limit' => $sql_limit, 'offset' => $sql_offset));
    ...
    <tr>
        <td>
            <a href="<?php echo G5_SUBSCRIPTION_URL; ?>/orderinquiryview.php?od_id=<?php echo $row['od_id']; ?>&amp;uid=<?php echo $uid; ?>"><?php echo $row['od_id']; ?></a>
        </td>
