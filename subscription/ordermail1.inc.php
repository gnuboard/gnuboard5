...
$result = sql_bind_select("{$g5['g5_subscription_cart_table']} a left join {$g5['g5_shop_item_table']} b on ( a.it_id = b.it_id )", $select_field,
array('a.od_id' => $od_id, 'a.ct_select' => 1), array('groupBy'=>'a.it_id', 'orderBy' => 'a.ct_id', 'orderType' => 'asc'));
...
for ($i=0; $row=sql_fetch_array($result); $i++)
{
    ...
    */
    ...
    $select_field = 'SUM(IF(io_type = 1, (io_price * ct_qty), ((ct_price + io_price) * ct_qty))) as price,
                    SUM(ct_point * ct_qty) as point,
                    SUM(ct_qty) as qty';
                    
    $sum = sql_bind_select_fetch($g5['g5_subscription_cart_table'], $select_field, array('it_id' => $row['it_id'], 'od_id' => $od_id, 'ct_select' => 1));
    ...
    */
    ...
    $result2 = sql_bind_select($g5['g5_subscription_cart_table'], 'ct_option, ct_qty, io_price',
array('it_id' => $row['it_id'], 'od_id' => $od_id, 'ct_select' => 1), array('orderBy' => 'io_type asc, ct_id', 'orderType' => 'asc'));
