...
if (function_exists('before_check_subscription_cart_price')) {
    before_check_subscription_cart_price($s_cart_id, true, true, true);
}
...
if (G5_IS_MOBILE) {
    include_once G5_MSUBSCRIPTION_PATH . '/cart.php';
...
if (defined('G5_THEME_SUBSCRIPTION_PATH')) {
    $theme_cart_file = G5_THEME_SUBSCRIPTION_PATH . '/cart.php';
...
<ul class="cart-heading">
    ...
    <li class="linked-title is-subscription-cart-link active">정기구독 <span class="cart-number"><?php echo $subscription_cart_datas ? count($subscription_cart_datas) : ''; ?></span></li>
</ul>
...
<div id="sod_bsk" class="od_prd_list">
    ...
    <form name="frmcartlist" id="sod_bsk_list" class="2017_renewal_itemform" method="post" action="<?php echo $subscription_cart_action_url; ?>">
        ...
        <div id="sod_bsk_act">
            <?php if ($i == 0) { ?>
                <a href="<?php echo G5_SUBSCRIPTION_URL; ?>/" class="btn01">쇼핑 계속하기</a>
            <?php } else { ?>
                <input type="hidden" name="url" value="./orderform.php">
                <input type="hidden" name="records" value="<?php echo $i; ?>">
                <input type="hidden" name="act" value="">
                <a href="<?php echo subscription_category_url($continue_sc_id); ?>" class="btn01">쇼핑 계속하기</a>
