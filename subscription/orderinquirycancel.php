...
// 장바구니 자료 취소
$result = sql_bind_update($g5['g5_subscription_cart_table'], array('ct_status'=>'cancel'), array('od_id'=>$od['od_id'], 'mb_id'=>$member['mb_id']));

// 주문 비활성화
$updates = array('od_enable_status'=>'0');

$updates['od_subscription_memo'] = array('function' => 'CONCAT', 'args' => array('od_subscription_memo', "\n주문자 본인 직접 취소 - ".G5_TIME_YMDHIS." (취소이유 : {$cancel_memo})"));
