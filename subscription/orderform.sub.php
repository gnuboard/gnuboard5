...
$(function(){
    $("#od_hope_date").datepicker({ changeMonth: true, changeYear: true, dateFormat: "yy-mm-dd", showButtonPanel: true, yearRange: "c-99:c+99", minDate: "+<?php echo (int) get_subs_option('su_hope_date_after'); ?>d;", maxDate: "+<?php echo (int) get_subs_option('su_hope_date_after') + 6; ?>d;" });
});
<?php } ?>
</script>