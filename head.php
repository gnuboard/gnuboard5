...
<div id="hd">
    ...
    <div id="hd_wrapper">
        ...
        <ul id="hd_qnb">
            ...
            <li><a href="<?php echo G5_BBS_URL ?>/current_connect.php" class="visit"><i class="fa fa-users" aria-hidden="true"></i> 접속자 <span><?php echo connect('basic'); // 현재 접속자수, 테마의 스킨을 사용하려면 스킨을 theme/basic 과 같이 지정  ?></span></a></li>
