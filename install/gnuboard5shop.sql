...
CREATE TABLE IF NOT EXISTS `g5_shop_cart` (
  ...
  `ct_select_time` datetime DEFAULT NULL,
  PRIMARY KEY (`ct_id`),
  KEY `od_id` (`od_id`),
  KEY `it_id` (`it_id`),
...
CREATE TABLE IF NOT EXISTS `g5_shop_coupon` (
  ...
  `od_id` bigint(20) unsigned NOT NULL,
  `cp_datetime` DATETIME DEFAULT NULL,
  PRIMARY KEY (`cp_no`),
...
CREATE TABLE IF NOT EXISTS `g5_shop_coupon_log` (
  ...
  `cp_price` int(11) NOT NULL DEFAULT '0',
  `cl_datetime` datetime DEFAULT NULL,
  PRIMARY KEY (`cl_id`),
  KEY `mb_id` (`mb_id`),
  KEY `od_id` (`od_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `g5_shop_coupon_zone` (
  ...
  `cz_datetime` DATETIME DEFAULT NULL,
  PRIMARY KEY (`cz_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `g5_shop_item` (
  ...
  `it_time` datetime DEFAULT NULL,
  `it_update_time` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `g5_shop_order` (
  ...
  `od_invoice_time` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `g5_shop_order_delete` (
  ...
  `de_datetime` datetime DEFAULT NULL,
  PRIMARY KEY (`de_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `g5_shop_personalpay` (
  ...
  `pp_receipt_time` DATETIME DEFAULT NULL,
