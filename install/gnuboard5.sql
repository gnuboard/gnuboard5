...
CREATE TABLE IF NOT EXISTS `g5_board_file` (
  ...
  `bf_datetime` datetime NOT NULL DEFAULT '9999-12-31 23:59:59',
...
CREATE TABLE IF NOT EXISTS `g5_board_good` (
  ...
  `bg_datetime` datetime NOT NULL DEFAULT '9999-12-31 23:59:59',
  PRIMARY KEY  (`bg_id`),
...
CREATE TABLE IF NOT EXISTS `g5_board_new` (
  ...
  `bn_datetime` datetime NOT NULL DEFAULT '9999-12-31 23:59:59',
  `mb_id` varchar(20) NOT NULL default '',
  PRIMARY KEY  (`bn_id`),
  KEY `mb_id` (`mb_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `g5_member_cert_history` (
  ...
  `ch_datetime` datetime NOT NULL DEFAULT '9999-12-31 23:59:59',
  PRIMARY KEY (`ch_id`),
  KEY `mb_id` (`mb_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `g5_group_member` (
  ...
  `gr_id` varchar(255) NOT NULL default '',
  `mb_id` varchar(20) NOT NULL default '',
  `gm_datetime` datetime NOT NULL DEFAULT '9999-12-31 23:59:59',
  PRIMARY KEY  (`gm_id`),
  KEY `gr_id` (`gr_id`),
  KEY `mb_id` (`mb_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `g5_login` (
  ...
  `mb_id` varchar(20) NOT NULL default '',
  `lo_datetime` datetime NOT NULL DEFAULT '9999-12-31 23:59:59',
...
CREATE TABLE IF NOT EXISTS `g5_mail` (
  ...
  `ma_time` datetime NOT NULL DEFAULT '9999-12-31 23:59:59',
...
CREATE TABLE IF NOT EXISTS `g5_member` (
  ...
  `mb_today_login` datetime NOT NULL DEFAULT '9999-12-31 23:59:59',
  `mb_login_ip` varchar(255) NOT NULL default '',
  `mb_datetime` datetime NOT NULL DEFAULT '9999-12-31 23:59:59',
  `mb_ip` varchar(255) NOT NULL default '',
  `mb_leave_date` varchar(8) NOT NULL default '',
  `mb_intercept_date` varchar(8) NOT NULL default '',
  `mb_email_certify` datetime NOT NULL DEFAULT '9999-12-31 23:59:59',
...
CREATE TABLE IF NOT EXISTS `g5_memo` (
  ...
  `me_send_datetime` datetime NOT NULL DEFAULT '9999-12-31 23:59:59',
  `me_read_datetime` datetime NOT NULL DEFAULT '9999-12-31 23:59:59',
...
CREATE TABLE IF NOT EXISTS `g5_point` (
  ...
  `mb_id` varchar(20) NOT NULL default '',
  `po_datetime` datetime NOT NULL DEFAULT '9999-12-31 23:59:59',
...
CREATE TABLE IF NOT EXISTS `g5_poll_etc` (
  ...
  `pc_datetime` datetime NOT NULL DEFAULT '9999-12-31 23:59:59',
  PRIMARY KEY  (`pc_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `g5_scrap` (
  ...
  `ms_datetime` datetime NOT NULL DEFAULT '9999-12-31 23:59:59',
  PRIMARY KEY  (`ms_id`),
  KEY `mb_id` (`mb_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `g5_qa_content` (
  ...
  `qa_datetime` datetime NOT NULL DEFAULT '9999-12-31 23:59:59',
  `qa_1` varchar(255) NOT NULL DEFAULT '',
  `qa_2` varchar(255) NOT NULL DEFAULT '',
  `qa_3` varchar(255) NOT NULL DEFAULT '',
  `qa_4` varchar(255) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `g5_member_social_profiles` (
  ...
  `mp_register_day` datetime NOT NULL DEFAULT '9999-12-31 23:59:59',
  `mp_latest_day` datetime NOT NULL DEFAULT '9999-12-31 23:59:59',
...
CREATE TABLE IF NOT EXISTS `g5_new_win` (
  ...
  `nw_begin_time` datetime NOT NULL DEFAULT '9999-12-31 23:59:59',
  `nw_end_time` datetime NOT NULL DEFAULT '9999-12-31 23:59:59',
