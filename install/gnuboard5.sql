...
CREATE TABLE IF NOT EXISTS `g5_member` (
  ...
  `mb_16` varchar(255) NOT NULL default '',
  `mb_17` varchar(255) NOT NULL default '',
  `mb_18` varchar(255) NOT NULL default '',
  `mb_19` varchar(255) NOT NULL default '',
  `mb_20` varchar(255) NOT NULL default '',
  PRIMARY KEY  (`mb_no`),
