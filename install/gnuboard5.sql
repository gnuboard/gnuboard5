...
CREATE TABLE IF NOT EXISTS `g5_board_file` (
  ...
  `bf_datetime` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `g5_board_good` (
  ...
  `bg_datetime` datetime DEFAULT NULL,
  PRIMARY KEY  (`bg_id`),
...
CREATE TABLE IF NOT EXISTS `g5_group_member` (
  ...
  `gr_id` varchar(255) NOT NULL default '',
  `mb_id` varchar(20) NOT NULL default '',
  `gm_datetime` datetime DEFAULT NULL,
  PRIMARY KEY  (`gm_id`),
  KEY `gr_id` (`gr_id`),
  KEY `mb_id` (`mb_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `g5_login` (
  ...
  `mb_id` varchar(20) NOT NULL default '',
  `lo_datetime` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `g5_member` (
  ...
  `mb_today_login` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `g5_memo` (
  ...
  `me_send_datetime` datetime DEFAULT NULL,
  `me_read_datetime` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `g5_poll_etc` (
  ...
  `pc_datetime` datetime DEFAULT NULL,
  PRIMARY KEY  (`pc_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `g5_scrap` (
  ...
  `ms_datetime` datetime DEFAULT NULL,
  PRIMARY KEY  (`ms_id`),
  KEY `mb_id` (`mb_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `g5_member_social_profiles` (
  ...
  `mp_register_day` datetime DEFAULT NULL,
  `mp_latest_day` datetime DEFAULT NULL,
