...
CREATE TABLE IF NOT EXISTS `g5_config` (
  ...
  `cf_email_wr_site_admin` tinyint(4) NOT NULL DEFAULT '0',
  `cf_email_wr_group_admin` tinyint(4) NOT NULL DEFAULT '0',
  `cf_email_wr_board_admin` tinyint(4) NOT NULL DEFAULT '0',
  `cf_email_wr_write` tinyint(4) NOT NULL DEFAULT '0',
  `cf_email_wr_comment_all` tinyint(4) NOT NULL DEFAULT '0',
  `cf_email_mb_super_admin` tinyint(4) NOT NULL DEFAULT '0',
  `cf_email_mb_site_admin` tinyint(4) NOT NULL DEFAULT '0',
  ...
  `cf_robots` tinyint(4) NOT NULL DEFAULT '0',
  `cf_dev_mode` tinyint(4) NOT NULL DEFAULT '0',
  `cf_dev_ip` varchar(255) NOT NULL DEFAULT '',
  `cf_admins_ip` text NOT NULL DEFAULT '',
  `cf_lang_type` varchar(255) NOT NULL DEFAULT 'ko',
  `cf_view_mode` tinyint(4) NOT NULL DEFAULT '0',
