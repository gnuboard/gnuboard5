...
if ($w == "")
{
    ...
    $it['sc_id'] = get_cookie("ck_sc_id");
    $it['sc_id2'] = get_cookie("ck_sc_id2");
    $it['sc_id3'] = get_cookie("ck_sc_id3");
    if (!$it['sc_id'])
    {
        $sql = " select sc_id from {$g5['g5_subscription_category_table']} order by sc_order, sc_id limit 1 ";
        $row = sql_fetch($sql);
...
else if ($w == "u")
{
    ...
    if ($is_admin != 'super')
    {
        $sql = " select it_id from {$g5['g5_subscription_item_table']} a, {$g5['g5_subscription_category_table']} b
                  where a.it_id = '$it_id'
                    and a.sc_id = b.sc_id
                    and b.sc_mb_id = '{$member['mb_id']}' ";
        $row = sql_fetch($sql);
        if (!$row['it_id'])
...
if ($is_admin != 'super')
    $sql .= " where sc_mb_id = '{$member['mb_id']}' ";
$sql .= " order by sc_order, sc_id ";
$result = sql_query($sql);
for ($i=0; $row=sql_fetch_array($result); $i++)
{
    $len = strlen($row['sc_id']) / 2 - 1;

    $nbsp = "";
    for ($i=0; $i<$len; $i++)
        $nbsp .= "&nbsp;&nbsp;&nbsp;";

    $category_select .= "<option value=\"{$row['sc_id']}\">$nbsp{$row['sc_name']}</option>\n";

    $script .= "sc_use['{$row['sc_id']}'] = {$row['sc_use']};\n";
    $script .= "sc_stock_qty['{$row['sc_id']}'] = {$row['sc_stock_qty']};\n";
    //$script .= "sc_explan_html['$row[sc_id]'] = $row[sc_explan_html];\n";
...
<section id="anc_sitfrm_cate">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tbody>
        <tr>
            <th scope="row"><label for="sc_id">기본분류</label></th>
            <td>
                <?php if ($w == "") echo help("기본분류를 선택하면, 판매/재고/HTML사용/판매자 E-mail 등을, 선택한 분류의 기본값으로 설정합니다."); ?>
                <select name="sc_id" id="sc_id" onchange="categorychange(this.form)">
                    <option value="">선택하세요</option>
                    <?php echo conv_selected_option($category_select, $it['sc_id']); ?>
                </select>
                <script>
                    var sc_use = new Array();
                    var sc_stock_qty = new Array();
                    //var sc_explan_html = new Array();
                    var sc_sell_email = new Array();
                    var sc_opt1_subject = new Array();
                    var sc_opt2_subject = new Array();
                    var sc_opt3_subject = new Array();
                    var sc_opt4_subject = new Array();
                    var sc_opt5_subject = new Array();
                    var sc_opt6_subject = new Array();
                    <?php echo "\n$script"; ?>
                </script>
            </td>
        </tr>
        <?php for ($i=2; $i<=3; $i++) { ?>
        <tr>
            <th scope="row"><label for="sc_id<?php echo $i; ?>"><?php echo $i; ?>차 분류</label></th>
            <td>
                <?php echo help($i.'차 분류는 기본 분류의 하위 분류 개념이 아니므로 기본 분류 선택시 해당 상품이 포함될 최하위 분류만 선택하시면 됩니다.'); ?>
                <select name="sc_id<?php echo $i; ?>" id="sc_id<?php echo $i; ?>">
                    <option value="">선택하세요</option>
                    <?php echo conv_selected_option($category_select, $it['sc_id'.$i]); ?>
                </select>
            </td>
        </tr>
        <?php } ?>
...
<section id="anc_sitfrm_skin">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td class="td_grpset">
                <input type="checkbox" name="chk_sc_it_skin" value="1" id="chk_sc_it_skin">
                <label for="chk_sc_it_skin">분류적용</label>
        ...
        <tr>
            ...
            <td class="td_grpset">
                <input type="checkbox" name="chk_sc_it_mobile_skin" value="1" id="chk_sc_it_mobile_skin">
                <label for="chk_sc_it_mobile_skin">분류적용</label>
...
<section id="anc_sitfrm_ini">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td colspan="2">
                ...
                <?php } else { ?>
                    ...
                    <span class="frm_sc_id"><?php echo $it['it_id']; ?></span>
                    <a href="<?php echo subscription_item_url($it_id); ?>" class="btn_frmline">상품확인</a>
                    <a href="<?php echo G5_ADMIN_URL; ?>/subscription_admin/itemuselist.php?sfl=a.it_id&amp;stx=<?php echo $it_id; ?>" class="btn_frmline">사용후기</a>
                    <a href="<?php echo G5_ADMIN_URL; ?>/subscription_admin/itemqalist.php?sfl=a.it_id&amp;stx=<?php echo $it_id; ?>" class="btn_frmline">상품문의</a>
                <?php } ?>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="td_grpset">
                <input type="checkbox" name="chk_sc_it_basic" value="1" id="chk_sc_it_basic">
                <label for="chk_sc_it_basic">분류적용</label>
        ...
        <tr>
            ...
            <td class="td_grpset">
                <input type="checkbox" name="chk_sc_it_order" value="1" id="chk_sc_it_order">
                <label for="chk_sc_it_order">분류적용</label>
        ...
        <tr>
            ...
            <td class="td_grpset">
                ...
                <label for="chk_sc_it_type">분류적용</label>
        ...
        <tr>
            ...
            <td class="td_grpset">
                <input type="checkbox" name="chk_sc_it_maker" value="1" id="chk_sc_it_maker">
                <label for="chk_sc_it_maker">분류적용</label>
        ...
        <tr>
            ...
            <td class="td_grpset">
                <input type="checkbox" name="chk_sc_it_origin" value="1" id="chk_sc_it_origin">
                <label for="chk_sc_it_origin">분류적용</label>
        ...
        <tr>
            ...
            <td class="td_grpset">
                <input type="checkbox" name="chk_sc_it_brand" value="1" id="chk_sc_it_brand">
                <label for="chk_sc_it_brand">분류적용</label>
        ...
        <tr>
            ...
            <td class="td_grpset">
                <input type="checkbox" name="chk_sc_it_model" value="1" id="chk_sc_it_model">
                <label for="chk_sc_it_model">분류적용</label>
        ...
        <tr>
            ...
            <td class="td_grpset">
                <input type="checkbox" name="chk_sc_it_use" value="1" id="chk_sc_it_use">
                <label for="chk_sc_it_use">분류적용</label>
        ...
        <tr>
            ...
            <td class="td_grpset">
                <input type="checkbox" name="chk_sc_it_nocoupon" value="1" id="chk_sc_it_nocoupon">
                <label for="chk_sc_it_nocoupon">분류적용</label>
        ...
        <tr>
            ...
            <td class="td_grpset">
                <input type="checkbox" name="chk_sc_it_sell_email" value="1" id="chk_sc_it_sell_email">
                <label for="chk_sc_it_sell_email">분류적용</label>
        ...
        <tr>
            <th scope="row"><label for="it_subscription_memo">상점메모</label></th>
            <td><textarea name="it_subscription_memo" id="it_subscription_memo"><?php echo html_purifier($it['it_subscription_memo']); ?></textarea></td>
            <td class="td_grpset">
                <input type="checkbox" name="chk_sc_it_subscription_memo" value="1" id="chk_sc_it_subscription_memo">
                <label for="chk_sc_it_subscription_memo">분류적용</label>
                <input type="checkbox" name="chk_all_it_subscription_memo" value="1" id="chk_all_it_subscription_memo">
                <label for="chk_all_it_subscription_memo">전체적용</label>
            </td>
        </tr>
        </tbody>
        </table>
...
<section id="anc_sitfrm_compact">
    ...
    <div id="sit_compact_fields"><?php include_once(G5_ADMIN_PATH.'/subscription_admin/iteminfo.php'); ?></div>
</section>
...
$(function(){
    $(document).on("change", "#it_info_gubun", function() {
        var gubun = $(this).val();
        $.post(
            "<?php echo G5_ADMIN_URL; ?>/subscription_admin/iteminfo.php",
...
<section id="anc_sitfrm_cost">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td class="td_grpset">
                <input type="checkbox" name="chk_sc_it_price" value="1" id="chk_sc_it_price">
                <label for="chk_sc_it_price">분류적용</label>
        ...
        <tr>
            ...
            <td class="td_grpset">
                <input type="checkbox" name="chk_sc_it_cust_price" value="1" id="chk_sc_it_cust_price">
                <label for="chk_sc_it_cust_price">분류적용</label>
        ...
        <tr>
            ...
            <td class="td_grpset">
                <input type="checkbox" name="chk_sc_it_point_type" value="1" id="chk_sc_it_point_type">
                <label for="chk_sc_it_point_type">분류적용</label>
        ...
        <tr>
            ...
            <td class="td_grpset">
                <input type="checkbox" name="chk_sc_it_point" value="1" id="chk_sc_it_point">
                <label for="chk_sc_it_point">분류적용</label>
        ...
        <tr>
            ...
            <td class="td_grpset">
                <input type="checkbox" name="chk_sc_it_supply_point" value="1" id="chk_sc_it_supply_point">
                <label for="chk_sc_it_supply_point">분류적용</label>
        ...
        <tr>
            ...
            <td class="td_grpset">
                <input type="checkbox" name="chk_sc_it_soldout" value="1" id="chk_sc_it_soldout">
                <label for="chk_sc_it_soldout">분류적용</label>
        ...
        <tr>
            ...
            <td class="td_grpset">
                <input type="checkbox" name="chk_sc_it_stock_qty" value="1" id="chk_sc_it_stock_qty">
                <label for="chk_sc_it_stock_qty">분류적용</label>
        ...
        <tr>
            ...
            <td class="td_grpset">
                <input type="checkbox" name="chk_sc_it_noti_qty" value="1" id="chk_sc_it_noti_qty">
                <label for="chk_sc_it_noti_qty">분류적용</label>
        ...
        <tr>
            ...
            <td class="td_grpset">
                <input type="checkbox" name="chk_sc_it_buy_min_qty" value="1" id="chk_sc_it_buy_min_qty">
                <label for="chk_sc_it_buy_min_qty">분류적용</label>
        ...
        <tr>
            ...
            <td class="td_grpset">
                <input type="checkbox" name="chk_sc_it_buy_max_qty" value="1" id="chk_sc_it_buy_max_qty">
                <label for="chk_sc_it_buy_max_qty">분류적용</label>
        ...
        <tr>
            ...
            <td class="td_grpset">
                <input type="checkbox" name="chk_sc_it_notax" value="1" id="chk_sc_it_notax">
                <label for="chk_sc_it_notax">분류적용</label>
        ...
        <tr>
            ...
            <td colspan="2">
                ...
                <div id="sit_option_frm"><?php include_once(G5_ADMIN_PATH.'/subscription_admin/itemoption.php'); ?></div>
                ...
                $(function() {
                    ...
                    $("#option_table_create").click(function() {
                        ...
                        $.post(
                            "<?php echo G5_ADMIN_URL; ?>/subscription_admin/itemoption.php",
        ...
        <tr>
            ...
            <td colspan="2">
                ...
                <div id="sit_option_addfrm"><?php include_once(G5_ADMIN_PATH.'/subscription_admin/itemsupply.php'); ?></div>
                ...
                $(function() {
                    ...
                    $("#supply_table_create").click(function() {
                        ...
                        $.post(
                            "<?php echo G5_ADMIN_URL; ?>/subscription_admin/itemsupply.php",
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                ...
                $it_img_exists = run_replace('subscription_item_image_exists', (is_file($it_img) && file_exists($it_img)), $it, $i);

                if($it_img_exists) {
                    $thumb = get_it_thumbnail($it['it_img'.$i], 25, 25);
                    $img_tag = run_replace('subscription_item_image_tag', '<img src="'.G5_DATA_URL.'/item/'.$it['it_img'.$i].'" class="subscription_item_preview_image" >', $it, $i);
                ?>
    ...
    <div class="compare_wrap">
                ...
                <select id="sch_relation">
                    ...
                    <?php
                        ...
                        for ($i=0; $row=sql_fetch_array($result); $i++)
                        {
                            ...
                            echo "<option value=\"{$row['sc_id']}\">$nbsp{$row['sc_name']}</option>\n";
                        }
                    ?>
                </select>
            ...
            $(function() {
                $("#btn_search_item").click(function() {
                    ...
                    $("#relation").load(
                        ...
                        { it_id: "<?php echo $it_id; ?>", sc_id: sc_id, it_name: it_name }
                    );
                });
        ...
        <section class="compare_right">
            ...
            <div id="reg_relation" class="srel_sel">
                <?php
                $str = array();
                $sql = " select b.sc_id, b.it_id, b.it_name, b.it_price
                           from {$g5['g5_subscription_item_relation_table']} a
                           left join {$g5['g5_subscription_item_table']} b on (a.it_id2=b.it_id)
                          where a.it_id = '$it_id'
                          order by ir_no asc ";
                $result = sql_query($sql);
    ...
    <div class="compare_wrap">
        <section class="compare_left">
            ...
            <div id="event_list" class="srel_list srel_noneimg">
                <?php
                $sql = " select ev_id, ev_subject from {$g5['g5_subscription_event_table']} order by ev_id desc ";
                $result = sql_query($sql);
                for ($g=0; $row=sql_fetch_array($result); $g++) {
                    if($g == 0)
                        echo '<ul>';
        ...
        <section class="compare_right">
            ...
            <div id="reg_event_list" class="srel_sel srel_noneimg">
                ...
                $sql = " select b.ev_id, b.ev_subject
                           from {$g5['g5_subscription_event_item_table']} a
                           left join {$g5['g5_subscription_event_table']} b on (a.ev_id=b.ev_id)
                          where a.it_id = '$it_id'
...
<section id="anc_sitfrm_optional">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td class="td_grpset">
                <input type="checkbox" name="chk_sc_it_head_html" value="1" id="chk_sc_it_head_html">
                <label for="chk_sc_it_head_html">분류적용</label>
        ...
        <tr>
            ...
            <td class="td_grpset">
                <input type="checkbox" name="chk_sc_it_tail_html" value="1" id="chk_sc_it_tail_html">
                <label for="chk_sc_it_tail_html">분류적용</label>
        ...
        <tr>
            ...
            <td class="td_grpset">
                <input type="checkbox" name="chk_sc_it_mobile_head_html" value="1" id="chk_sc_it_mobile_head_html">
                <label for="chk_sc_it_mobile_head_html">분류적용</label>
        ...
        <tr>
            ...
            <td class="td_grpset">
                <input type="checkbox" name="chk_sc_it_mobile_tail_html" value="1" id="chk_sc_it_mobile_tail_html">
                <label for="chk_sc_it_mobile_tail_html">분류적용</label>
...
<section id="anc_sitfrm_extra">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td class="td_grpset">
                <input type="checkbox" name="chk_sc_<?php echo $i ?>" value="1" id="chk_sc_<?php echo $i ?>">
                <label for="chk_sc_<?php echo $i ?>">분류적용</label>
...
<div class="btn_fixed_top">
    ...
    <a href="<?php echo subscription_item_url($it_id); ?>" class="btn_02  btn">상품보기</a>
...
{
    var idx = f.sc_id.value;

    if (f.w.value == "" && idx)
    {
        f.it_use.checked = sc_use[idx] ? true : false;
        f.it_stock_qty.value = sc_stock_qty[idx];
        f.it_sell_email.value = sc_sell_email[idx];
    }
}
