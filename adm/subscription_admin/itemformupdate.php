...
$sc_id = isset($_POST['sc_id']) ? preg_replace('/[^0-9a-z]/i', '', $_POST['sc_id']) : '';
$sc_id2 = isset($_POST['sc_id2']) ? preg_replace('/[^0-9a-z]/i', '', $_POST['sc_id2']) : '';
$sc_id3 = isset($_POST['sc_id3']) ? preg_replace('/[^0-9a-z]/i', '', $_POST['sc_id3']) : '';

if ($is_admin != 'super') {     // 최고관리자가 아니면 체크
    if( $w === '' ){
        $sql = "select sc_mb_id from {$g5['g5_subscription_category_table']} where sc_id = '$sc_id'";
    } else {
        $sql = "select b.sc_mb_id from {$g5['g5_subscription_item_table']} a , {$g5['g5_subscription_category_table']} b where (a.sc_id = b.sc_id) and a.it_id = '$it_id'";
    }
    $checks = sql_fetch($sql);

    if( ! (isset($checks['sc_mb_id']) && $checks['sc_mb_id']) || $checks['sc_mb_id'] !== $member['mb_id'] ){
...
if($w == "u") {
    $sql = " select it_img1, it_img2, it_img3, it_img4, it_img5, it_img6, it_img7, it_img8, it_img9, it_img10
                from {$g5['g5_subscription_item_table']}
                where it_id = '$it_id' ";
    $file = sql_fetch($sql);
...
if ($w == "" || $w == "u")
{
    ...
    //@setcookie("ck_sc_id",  $sc_id,  time() + 86400*31, $default[de_cookie_dir], $default[de_cookie_domain]);
    ...
    @set_cookie("ck_sc_id", $sc_id, time() + 86400*31);
    @set_cookie("ck_sc_id2", $sc_id2, time() + 86400*31);
    @set_cookie("ck_sc_id3", $sc_id3, time() + 86400*31);
...
// 관련상품을 우선 삭제함
sql_query(" delete from {$g5['g5_subscription_item_relation_table']} where it_id = '$it_id' ");

// 관련상품의 반대도 삭제
sql_query(" delete from {$g5['g5_subscription_item_relation_table']} where it_id2 = '$it_id' ");

// 이벤트상품을 우선 삭제함
sql_query(" delete from {$g5['g5_subscription_event_item_table']} where it_id = '$it_id' ");

// 선택옵션
sql_query(" delete from {$g5['g5_subscription_item_option_table']} where io_type = '0' and it_id = '$it_id' "); // 기존선택옵션삭제
...
// 추가옵션
sql_query(" delete from {$g5['g5_subscription_item_option_table']} where io_type = '1' and it_id = '$it_id' "); // 기존추가옵션삭제
...
if ($w == "" || $w == "u")
{
    ...
    for ($i=0; $i<count($it_id2); $i++)
    {
        if (trim($it_id2[$i]))
        {
            $sql = " insert into {$g5['g5_subscription_item_relation_table']}
                        set it_id  = '$it_id',
    ...
    for ($i=0; $i<count($ev_id); $i++)
    {
        if (trim($ev_id[$i]))
        {
            $sql = " insert into {$g5['g5_subscription_event_item_table']}
...
if($option_count) {
    $comma = '';
    $sql = " INSERT INTO {$g5['g5_subscription_item_option_table']}
...
// 동일 분류내 상품 동일 옵션 적용
$sc_fields = '';
if(is_checked('chk_sc_it_skin'))                $sc_fields .= " , it_skin = '$it_skin' ";
if(is_checked('chk_sc_it_mobile_skin'))         $sc_fields .= " , it_mobile_skin = '$it_mobile_skin' ";
if(is_checked('chk_sc_it_basic'))               $sc_fields .= " , it_basic = '$it_basic' ";
if(is_checked('chk_sc_it_order'))               $sc_fields .= " , it_order = '$it_order' ";
if(is_checked('chk_sc_it_type'))                $sc_fields .= " , it_type1 = '$it_type1', it_type2 = '$it_type2', it_type3 = '$it_type3', it_type4 = '$it_type4', it_type5 = '$it_type5' ";
if(is_checked('chk_sc_it_maker'))               $sc_fields .= " , it_maker = '$it_maker' ";
if(is_checked('chk_sc_it_origin'))              $sc_fields .= " , it_origin = '$it_origin' ";
if(is_checked('chk_sc_it_brand'))               $sc_fields .= " , it_brand = '$it_brand' ";
if(is_checked('chk_sc_it_model'))               $sc_fields .= " , it_model = '$it_model' ";
...
if(is_checked('chk_sc_it_info'))                $sc_fields .= " , it_info_gubun = '$it_info_gubun', it_info_value = '$it_info_value' ";
if(is_checked('chk_sc_it_price'))               $sc_fields .= " , it_price = '$it_price' ";
if(is_checked('chk_sc_it_cust_price'))          $sc_fields .= " , it_cust_price = '$it_cust_price' ";
if(is_checked('chk_sc_it_point'))               $sc_fields .= " , it_point = '$it_point' ";
if(is_checked('chk_sc_it_point_type'))          $sc_fields .= " , it_point_type = '$it_point_type' ";
if(is_checked('chk_sc_it_supply_point'))        $sc_fields .= " , it_supply_point = '$it_supply_point' ";
if(is_checked('chk_sc_it_stock_qty'))           $sc_fields .= " , it_stock_qty = '$it_stock_qty' ";
if(is_checked('chk_sc_it_noti_qty'))            $sc_fields .= " , it_noti_qty = '$it_noti_qty' ";
if(is_checked('chk_sc_it_sendcost'))            $sc_fields .= " , it_sc_type = '$it_sc_type', it_sc_method = '$it_sc_method', it_sc_price = '$it_sc_price', it_sc_minimum = '$it_sc_minimum', it_sc_qty = '$it_sc_qty' ";
if(is_checked('chk_sc_it_buy_min_qty'))         $sc_fields .= " , it_buy_min_qty = '$it_buy_min_qty' ";
if(is_checked('chk_sc_it_buy_max_qty'))         $sc_fields .= " , it_buy_max_qty = '$it_buy_max_qty' ";
if(is_checked('chk_sc_it_head_html'))           $sc_fields .= " , it_head_html = '$it_head_html' ";
if(is_checked('chk_sc_it_tail_html'))           $sc_fields .= " , it_tail_html = '$it_tail_html' ";
if(is_checked('chk_sc_it_mobile_head_html'))    $sc_fields .= " , it_mobile_head_html = '$it_mobile_head_html' ";
if(is_checked('chk_sc_it_mobile_tail_html'))    $sc_fields .= " , it_mobile_tail_html = '$it_mobile_tail_html' ";
if(is_checked('chk_sc_1'))                      $sc_fields .= " , it_1_subj = '$it_1_subj', it_1 = '$it_1' ";
if(is_checked('chk_sc_2'))                      $sc_fields .= " , it_2_subj = '$it_2_subj', it_2 = '$it_2' ";
if(is_checked('chk_sc_3'))                      $sc_fields .= " , it_3_subj = '$it_3_subj', it_3 = '$it_3' ";
if(is_checked('chk_sc_4'))                      $sc_fields .= " , it_4_subj = '$it_4_subj', it_4 = '$it_4' ";
if(is_checked('chk_sc_5'))                      $sc_fields .= " , it_5_subj = '$it_5_subj', it_5 = '$it_5' ";
if(is_checked('chk_sc_6'))                      $sc_fields .= " , it_6_subj = '$it_6_subj', it_6 = '$it_6' ";
if(is_checked('chk_sc_7'))                      $sc_fields .= " , it_7_subj = '$it_7_subj', it_7 = '$it_7' ";
if(is_checked('chk_sc_8'))                      $sc_fields .= " , it_8_subj = '$it_8_subj', it_8 = '$it_8' ";
if(is_checked('chk_sc_9'))                      $sc_fields .= " , it_9_subj = '$it_9_subj', it_9 = '$it_9' ";
if(is_checked('chk_sc_10'))                     $sc_fields .= " , it_10_subj = '$it_10_subj', it_10 = '$it_10' ";

if($sc_fields) {
    sql_query(" update {$g5['g5_subscription_item_table']} set it_name = it_name {$sc_fields} where sc_id = '$sc_id' ");
    if($sc_id2)
        sql_query(" update {$g5['g5_subscription_item_table']} set it_name = it_name {$sc_fields} where sc_id2 = '$sc_id2' ");
    if($sc_id3)
        sql_query(" update {$g5['g5_subscription_item_table']} set it_name = it_name {$sc_fields} where sc_id3 = '$sc_id3' ");
}
...
if($all_fields) {
    sql_query(" update {$g5['g5_subscription_item_table']} set it_name = it_name {$all_fields} ");
}

$is_seo_title_edit = $w ? true : false;
if( function_exists('subscription_seo_title_update') ) subscription_seo_title_update($it_id, $is_seo_title_edit);

run_event('subscription_admin_itemformupdate', $it_id, $w);
...
if ($w == "u") {
    ...
    $qstr = "sc_id=$sc_id&amp;sfl=$sfl&amp;sca=$sca&amp;page=$page&amp;stx=".urlencode($stx)."&amp;save_stx=".urlencode($save_stx);
