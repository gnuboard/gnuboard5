...
$od_shop_memo = isset($_POST['od_subscription_memo']) ? strip_tags($_POST['od_subscription_memo']) : '';
...
if(isset($_POST['mod_type']) && $_POST['mod_type'] === 'info') {
    $od_zip   = isset($_POST['od_zip']) ? preg_replace('/[^0-9]/', '', substr($_POST['od_zip'], 0, 6)) : '';
    $od_b_zip = isset($_POST['od_b_zip']) ? preg_replace('/[^0-9]/', '', substr($_POST['od_b_zip'], 0, 6)) : '';
    ...
    $sql = "update {$g5['g5_subscription_order_table']}
                set od_subscription_memo = '$od_subscription_memo' ";
