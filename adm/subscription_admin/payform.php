...
<section id="anc_sodr_list">
    ...
    <input type="hidden" name="sort2" value="<?php echo get_text($sort2); ?>">
    <input type="hidden" name="sel_field" value="<?php echo get_text($sel_field); ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        for($i=0; $row=sql_fetch_array($result); $i++) {
            ...
            // 조건부무료
            if($row['it_sc_type'] == 2) {
                $sendcost = get_item_sendcost($row['it_id'], $sum['price'], $sum['qty'], $pay['py_id']);
...
<section id="anc_sodr_pay">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <td class="td_numbig"><?php echo display_point($pay['py_receipt_point']); ?></td>
...
<section class="">
    ...
    <input type="hidden" name="py_id" value="<?php echo get_text($pay_id); ?>">
    <input type="hidden" name="sort1" value="<?php echo get_text($sort1); ?>">
    <input type="hidden" name="sort2" value="<?php echo get_text($sort2); ?>">
    <input type="hidden" name="sel_field" value="<?php echo get_text($sel_field); ?>">
    <input type="hidden" name="search" value="<?php echo get_text($search); ?>">
    <input type="hidden" name="page" value="<?php echo get_text($page); ?>">
    <input type="hidden" name="py_name" value="<?php echo get_text($pay['py_name']); ?>">
    <input type="hidden" name="py_hp" value="<?php echo get_text($pay['py_hp']); ?>">
    <input type="hidden" name="py_tno" value="<?php echo get_text($pay['py_tno']); ?>">
    <input type="hidden" name="py_escrow" value="<?php echo get_text($pay['py_escrow']); ?>">
    <input type="hidden" name="py_pg" value="<?php echo get_text($pay['py_pg']); ?>">
    ...
    <div class="compare_wrap">
        ...
        <section id="anc_sodr_paymo" class="compare_right">
            ...
            <div class="tbl_frm01">
                ...
                <tr>
                    <th scope="row"><label for="py_receipt_point">포인트 결제액</label></th>
                    <td><input type="text" name="py_receipt_point" value="<?php echo $pay['py_receipt_point']; ?>" id="py_receipt_point" class="frm_input" size="10"> 점</td>
                </tr>
                <tr>
    ...
    <div class="btn_confirm01 btn_confirm">
        ...
        <?php if($pay['py_status'] == '주문' && $pay['py_misu'] > 0) { ?>
        <a href="./personalpayform.php?popup=yes&amp;py_id=<?php echo $pay_id; ?>" id="personalpay_add" class="btn btn_02">개인결제추가</a>
        <?php } ?>
        <?php if($pay['py_misu'] < 0 && ($pay['py_receipt_price'] - $pay['py_refund_price']) > 0) { ?>
        <a href="./orderpartcancel.php?py_id=<?php echo $pay_id; ?>" id="orderpartcancel" class="btn btn_02"><?php echo $pay['py_settle_case']; ?> 부분취소</a>
        <?php } ?>
    ...
    <div class="compare_wrap">
        ...
        <section id="anc_sodr_orderer" class="compare_left">
            ...
            <div class="tbl_frm01">
                ...
                <tbody>
                <tr>
                    <th scope="row"><label for="py_name"><span class="sound_only">주문하신 분 </span>이름</label></th>
                ...
                <tr>
                    ...
                    <td>
                        <label for="py_zip" class="sound_only">우편번호</label>
                        <input type="text" name="py_zip" value="<?php echo get_text($pay['py_zip1']).get_text($pay['py_zip2']); ?>" id="py_zip" required class="frm_input required" size="5">
                        <button type="button" class="btn_frmline" onclick="win_zip('frmorderform3', 'py_zip', 'py_addr1', 'py_addr2', 'py_addr3', 'py_addr_jibeon');">주소 검색</button><br>
                        <span id="py_win_zip" style="display:block"></span>
                        <input type="text" name="py_addr1" value="<?php echo get_text($pay['py_addr1']); ?>" id="py_addr1" required class="frm_input required" size="35">
                        <label for="py_addr1">기본주소</label><br>
                        <input type="text" name="py_addr2" value="<?php echo get_text($pay['py_addr2']); ?>" id="py_addr2" class="frm_input" size="35">
                        <label for="py_addr2">상세주소</label>
                        <br>
                        <input type="text" name="py_addr3" value="<?php echo get_text($pay['py_addr3']); ?>" id="py_addr3" class="frm_input" size="35">
                        <label for="py_addr3">참고항목</label>
                        <input type="hidden" name="py_addr_jibeon" value="<?php echo get_text($pay['py_addr_jibeon']); ?>"><br>
                    </td>
                </tr>
                <tr>
                    <th scope="row"><label for="py_email"><span class="sound_only">주문하신 분 </span>E-mail</label></th>
                    <td><input type="text" name="py_email" value="<?php echo $pay['py_email']; ?>" id="py_email" required class="frm_input required" size="30"></td>
                </tr>
                <tr>
                    <th scope="row"><span class="sound_only">주문하신 분 </span>IP Address</th>
                    <td><?php echo $pay['py_ip']; ?></td>
                </tr>
                </tbody>
                </table>
            </div>
        ...
        <section id="anc_sodr_taker" class="compare_right">
            ...
            <div class="tbl_frm01">
                ...
                <tr>
                    ...
                    <td><input type="text" name="py_b_name" value="<?php echo get_text($pay['py_b_name']); ?>" id="py_b_name" required class="frm_input required"></td>
                </tr>
                <tr>
                    <th scope="row"><label for="py_b_tel"><span class="sound_only">받으시는 분 </span>전화번호</label></th>
                    <td><input type="text" name="py_b_tel" value="<?php echo get_text($pay['py_b_tel']); ?>" id="py_b_tel" required class="frm_input required"></td>
                </tr>
                <tr>
                    <th scope="row"><label for="py_b_hp"><span class="sound_only">받으시는 분 </span>핸드폰</label></th>
                    <td><input type="text" name="py_b_hp" value="<?php echo get_text($pay['py_b_hp']); ?>" id="py_b_hp" class="frm_input required"></td>
                </tr>
                <tr>
                    <th scope="row"><span class="sound_only">받으시는 분 </span>주소</th>
                    <td>
                        <label for="py_b_zip" class="sound_only">우편번호</label>
                        <input type="text" name="py_b_zip" value="<?php echo get_text($pay['py_b_zip1']).get_text($pay['py_b_zip2']); ?>" id="py_b_zip" required class="frm_input required" size="5">
                        ...
                        <input type="text" name="py_b_addr1" value="<?php echo get_text($pay['py_b_addr1']); ?>" id="py_b_addr1" required class="frm_input required" size="35">
                        <label for="py_b_addr1">기본주소</label>
                        <br>
                        <input type="text" name="py_b_addr2" value="<?php echo get_text($pay['py_b_addr2']); ?>" id="py_b_addr2" class="frm_input" size="35">
                        <label for="py_b_addr2">상세주소</label>
                        <br>
                        <input type="text" name="py_b_addr3" value="<?php echo get_text($pay['py_b_addr3']); ?>" id="py_b_addr3" class="frm_input" size="35">
                        <label for="py_b_addr3">참고항목</label>
                        <input type="hidden" name="py_b_addr_jibeon" value="<?php echo get_text($pay['py_b_addr_jibeon']); ?>"><br>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td><?php if ($pay['py_memo']) echo get_text($pay['py_memo'], 1);else echo "없음";?></td>
                </tr>
                </tbody>
                </table>
            </div>
