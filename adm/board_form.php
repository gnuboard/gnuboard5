...
<div class="btn_fixed_top">
    <?php if( $bo_table && $w ){ ?>
        ...
        <a href="./board_thumbnail_delete.php?bo_table=<?php echo $board['bo_table']; ?>&amp;<?php echo $qstr; ?>" onclick="return delete_confirm2('게시판 썸네일 파일을 삭제하시겠습니까?');" class="btn_02 btn">게시판 썸네일 삭제</a>
    <?php } ?>
