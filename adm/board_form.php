...
<section id="adm_bo_basic">
    ...
    <tr>
        ...
        <td headers="th104">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_category_list" name="chk_category_list" value="1">
        </td>
    </tr>
    <? if ($w == 'u') { ?>
    <tr>
...
<section id="adm_bo_rights">
    ...
    <tr>
        ...
        <td headers="th201">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_admin" name="chk_admin" value="1">
        </td>
    </tr>
    <tr>
        <th scope="row" id="th202"><label for="bo_list_level">목록보기 권한</label></th>
        <td headers="th202">
            <?=help('권한 1은 비회원, 2 이상 회원입니다.\n권한은 10 이 가장 높습니다.')?>
            <?=get_member_level_select('bo_list_level', 1, 10, $board['bo_list_level']) ?>
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_list_level" name="chk_list_level" value="1">
        </td>
    </tr>
    <tr>
        ...
        <td headers="th203">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_read_level" name="chk_read_level" value="1">
        </td>
    </tr>
    <tr>
        ...
        <td headers="th204">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_write_level" name="chk_write_level" value="1">
        </td>
    </tr>
    <tr>
        ...
        <td headers="th205">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_reply_level" name="chk_reply_level" value="1">
        </td>
    </tr>
    <tr>
        ...
        <td headers="th206">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_comment_level" name="chk_comment_level" value="1">
        </td>
    </tr>
    <tr>
        ...
        <td headers="th207">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_link_level" name="chk_link_level" value="1">
        </td>
    </tr>
    <tr>
        ...
        <td headers="th208">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_upload_level" name="chk_upload_level" value="1">
        </td>
    </tr>
    <tr>
        ...
        <td headers="th209">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_download_level" name="chk_download_level" value="1">
        </td>
    </tr>
    <tr>
        ...
        <td headers="th210">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_html_level" name="chk_html_level" value="1">
        </td>
    </tr>
    <tr>
        <th scope="row" id="th211"><label for="bo_trackback_level">트랙백쓰기 권한</label></th>
        <td headers="th211">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_trackback_level" name="chk_trackback_level" value="1">
        </td>
    </tr>
    </tbody>
    </table>
...
<section id="adm_bo_function">
    ...
    <tr>
        ...
        <td headers="th301">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_count_modify" name="chk_count_modify" value="1"></span>
        </td>
    </tr>
    <tr>
        ...
        <td headers="th302">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_count_delete" name="chk_count_delete" value="1"></span>
        </td>
    </tr>
    <tr>
        ...
        <td headers="th303">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_use_sideview" name="chk_use_sideview" value="1"></span>
        </td>
    </tr>
    <tr>
        ...
        <td headers="th304">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_use_file_content" name="chk_use_file_content" value="1"></span>
        </td>
    </tr>
    <tr>
        ...
        <td headers="th305">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_use_comment" name="chk_use_comment" value="1"></span>
        </td>
    </tr>
    <tr>
        <th scope="row" id="th306"><label for="bo_use_secret">비밀글 사용</label></th>
        <td headers="th306">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_use_secret" name="chk_use_secret" value="1"></span>
        </td>
    </tr>
    <tr>
        ...
        <td headers="th307">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_use_dhtml_editor" name="chk_use_dhtml_editor" value="1">
        </td>
    </tr>
    <tr>
        <th scope="row" id="th308"><label for="bo_use_rss_view">RSS 보이기 사용</label></th>
        <td headers="th308">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_use_rss_view" name="chk_use_rss_view" value="1">
        </td>
    </tr>
    <tr>
        ...
        <td headers="th309">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_use_good" name="chk_use_good" value="1">
        </td>
    </tr>
    <tr>
        ...
        <td headers="th310">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_use_nogood" name="chk_use_nogood" value="1">
        </td>
    </tr>
    <tr>
        ...
        <td headers="th311">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_use_name" name="chk_use_name" value="1">
        </td>
    </tr>
    <tr>
        ...
        <td headers="th312">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_use_signature" name="chk_use_signature" value="1">
        </td>
    </tr>
    <tr>
        ...
        <td headers="th313">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_use_ip_view" name="chk_use_ip_view" value="1">
        </td>
    </tr>
    <tr>
        ...
        <td headers="th314">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_use_trackback" name="chk_use_trackback" value="1">
        </td>
    </tr>
    <tr>
        ...
        <td headers="th315">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_use_list_content" name="chk_use_list_content" value="1">
        </td>
    </tr>
    <tr>
        ...
        <td headers="th316">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_use_list_view" name="chk_use_list_view" value="1">
        </td>
    </tr>
    <tr>
        ...
        <td headers="th317">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_use_email" name="chk_use_email" value="1">
        </td>
    </tr>
    <tr>
        ...
        <td headers="th318">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_upload_count" name="chk_upload_count" value="1">
        </td>
    </tr>
    <?
    ...
    ?>
    <tr>
        <th scope="row" id="th319"><label for="bo_upload_size">파일 업로드 용량</label></th>
        <td headers="th319">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_upload_size" name="chk_upload_size" value="1">
        </td>
    </tr>
    <tr>
        <th scope="row" id="th320"><label for="bo_write_min">최소 글수 제한</label></th>
        <td headers="th320">
            <?=help('글 입력시 최소 글자수를 설정. 0을 입력하면 검사하지 않음')?>
            <input type="text" id="bo_write_min" name="bo_write_min" numeric value="<?=$board['bo_write_min']?>">
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_write_min" name="chk_write_min" value="1">
        </td>
    </tr>
    <tr>
        <th scope="row" id="th321"><label for="bo_write_max">최대 글수 제한</label></th>
        <td headers="th321">
            <?=help('글 입력시 최대 글자수를 설정. 0을 입력하면 검사하지 않음')?>
            <input type="text" id="bo_write_max" name="bo_write_max" numeric value="<?=$board['bo_write_max']?>">
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_write_max" name="chk_write_max" value="1">
        </td>
    </tr>
    <tr>
        <th scope="row" id="th322"><label for="bo_comment_min">최소 코멘트수 제한</label></th>
        <td headers="th322">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_comment_min" name="chk_comment_min" value="1">
        </td>
    </tr>
    <tr>
        <th scope="row" id="th323"><label for="bo_comment_max">최대 코멘트수 제한</label></th>
        <td headers="th323">
            <?=help('코멘트 입력시 최소 글자수, 최대 글자수를 설정. 0을 입력하면 검사하지 않음')?>
            <input type="text" id="bo_comment_max" name="bo_comment_max" numeric value="<?=$board['bo_comment_max']?>">
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_comment_max" name="chk_comment_max" value="1">
        </td>
    </tr>
    <tr>
        ...
        <td headers="th324">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_use_search" name="chk_use_search" value="1">
        </td>
    </tr>
    <tr>
        <th scope="row" id="th325"><label for="bo_order_search">전체 검색 순서</label></th>
        <td headers="th325">
            <?=help('숫자가 낮은 게시판 부터 검색')?>
            <input type="text" id="bo_order_search" name="bo_order_search" value='<?=$board['bo_order_search']?>'>
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_order_search" name="chk_order_search" value="1">
        </td>
    </tr>
    </tbody>
    </table>
...
<section id="adm_bo_design">
    ...
    <tbody>
        <tr>
        <th scope="row" id="th400"><label for="bo_skin">스킨 디렉토리</label></th>
        <td headers="th400">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_skin" name="chk_skin" value="1">
        </td>
    </tr>
    <tr>
        <th scope="row" id="th401"><label for="bo_image_head">상단 이미지</label></th>
        <td headers="th401">
    ...
    <tr>
        <th scope="row" id="th402"><label for="bo_image_tail">하단 이미지</label></th>
        <td headers="th402">
    ...
    <tr>
        ...
        <td headers="th403">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_include_head" name="chk_include_head" value="1">
        </td>
    </tr>
    <tr>
        ...
        <td headers="th404">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_include_tail" name="chk_include_tail" value="1">
        </td>
    </tr>
        <tr>
        <th scope="row" id="th405"><label for="bo_content_head">상단 내용</label></th>
        <td headers="th405">
            <?=cheditor2('bo_content_head', $board['bo_content_head']);?>
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_content_head" name="chk_content_head" value="1">
        </td>
    </tr>
    <tr>
        <th scope="row" id="th406"><label for="bo_content_tail">하단 내용</label></th>
        <td headers="th406">
            <?=cheditor2('bo_content_tail', $board['bo_content_tail']);?>
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_content_tail" name="chk_content_tail" value="1">
        </td>
    </tr>
    <tr>
        ...
        <td headers="th407">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_insert_content" name="chk_insert_content" value="1">
        </td>
    </tr>
    <tr>
        <th scope="row" id="th408"><label for="bo_subject_len">제목 길이</label></th>
        <td headers="th408">
            <?=help('목록에서의 제목 글자수. 잘리는 글은 … 로 표시')?>
            <input type="text" id="bo_subject_len" name="bo_subject_len" required value="<?=$board[bo_subject_len]?>">
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_subject_len" name="chk_subject_len" value="1">
        </td>
    </tr>
        <tr>
        ...
        <td headers="th409">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_page_rows" name="chk_page_rows" value="1">
        </td>
    </tr>
    <tr>
        <th scope="row" id="th410"><label for="bo_gallery_cols">가로 이미지수</label></th>
        <td headers="th410">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_gallery_cols" name="chk_gallery_cols" value="1">
        </td>
    </tr>
    <tr>
        <th scope="row" id="th411"><label for="bo_table_width">게시판 테이블 폭</label></th>
        <td headers="th411">
            <?=help('100 이하는 %')?>
            <input type="text" id="bo_table_width" name="bo_table_width" required value="<?=$board[bo_table_width]?>">
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_table_width" name="chk_table_width" value="1">
        </td>
    </tr>
    <tr>
        <th scope="row" id="th412"><label for="bo_image_width">이미지 폭 크기</label></th>
        <td headers="th412">
            <?=help('게시판에서 출력되는 이미지의 폭 크기')?>
            <input type="text" id="bo_image_width" name="bo_image_width" required value="<?=$board['bo_image_width']?>"> 픽셀
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_image_width" name="chk_image_width" value="1">
        </td>
    </tr>
    <tr>
        <th scope="row" id="th413"><label for="bo_new">새글 아이콘</label></th>
        <td headers="th413">
            <?=help('글 입력후 new 이미지를 출력하는 시간')?>
            <input type="text" id="bo_new" name="bo_new" required value="<?=$board[bo_new]?>">
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_new" name="chk_new" value="1">
        </td>
    </tr>
    <tr>
        <th scope="row" id="th414"><label for="bo_hot">인기글 아이콘</label></th>
        <td headers="th414">
            <?=help('조회수가 설정값 이상이면 hot 이미지 출력')?>
            <input type="text" id="bo_hot" name="bo_hot" required value="<?=$board[bo_hot]?>">
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_hot" name="chk_hot" value="1">
        </td>
    </tr>
    <tr>
        <th scope="row" id="th415"><label for="bo_reply_order">답변 달기</label></th>
        <td headers="th415">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_reply_order" name="chk_reply_order" value="1">
        </td>
    </tr>
    <tr>
        ...
        <td headers="th416">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_sort_field" name="chk_sort_field" value="1">
        </td>
    </tbody>
    </table>
</section>
...
<section id="adm_bo_point">
    ...
    <tbody>
    <tr>
        <th scope="row" id="th501"><label for="chk_point">기본값으로 설정</label></th>
        <td headers="th501">
    ...
    <tr>
        ...
        <td headers="th502">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_read_point" name="chk_read_point" value="1">
        </td>
    </tr>
    <tr>
        ...
        <td headers="th503">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_write_point" name="chk_write_point" value="1">
        </td>
    </tr>
    <tr>
        ...
        <td headers="th504">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_comment_point" name="chk_comment_point" value="1">
        </td>
    </tr>
    <tr>
        ...
        <td headers="th505">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_download_point" name="chk_download_point" value="1">
        </td>
    </tr>
    </tbody>
    </table>
...
<section id="adm_bo_extra">
    ...
    <tr>
        ...
        <td headers="th6<?=$i?>">
            ...
            <span class="adm_field_group_setting"><input type="checkbox" id="chk_<?=$i?>" name="chk_<?=$i?>" value="1">
        </td>
    </tr>
    <? } ?>
    </tbody>
