...
if (isset($od_send_cost_area))
    $sql .= " , od_send_cost_area = '$od_send_cost_area' ";
if (isset($od_send_coupon))
    $sql .= " , od_send_coupon = '$od_send_coupon' ";
