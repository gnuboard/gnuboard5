...
<form name="fcategoryform" action="./categoryformupdate.php" onsubmit="return fcategoryformcheck(this);" method="post" enctype="multipart/form-data">
    ...
    <input type="hidden" name="ca_explan_html" value="<?php echo get_sanitize_input($ca['ca_explan_html']); ?>">
                ...
                <tbody>
                    ...
                    <?php if (defined('G5_USE_SUBSCRIPTION') && G5_USE_SUBSCRIPTION) { ?>
                        <tr>
                            ...
                            <td>
                                <?php echo help('쇼핑몰스킨은 shop 폴더이며, 정기결제스킨은 subscription 폴더를 사용합니다.<br>스킨파일은 item.form.skin.php 파일만 해당됩니다.'); ?>
