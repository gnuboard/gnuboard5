...
<li><a href=\"#frm_reset\">초기화면</a></li>
<li><a href=\"#frm_payment_info\">결제정보</a></li>
<li><a href=\"#frm_delivery_info\">배송정보</a></li>
<li><a href=\"#frm_etc_info\">기타정보</a></li>
<li><a href=\"#frm_sms_info\">SMS정보</a></li>
</ul>
";
?>
...
<section id="frm_reset" class="cbox">
    <h2>초기화면</h2>
        <?=$pg_anchor?>
    <table class="frm_tbl">
        <colgroup>
...
<section id ="frm_payment_info" class="cbox">
    <h2>결제정보</h2>
    ...
    <colgroup>
        ...
        <tr>
            ...
            <th scope="row" rowspan="2"><label for="de_bank_account">은행계좌번호</label></th>
            <td rowspan="2"><textarea rows="3" name="de_bank_account" id="de_bank_account" style="width:99%"><?=$default['de_bank_account']?></textarea></td>
        </tr>
        <tr>
            <th><label for="de_iche_use">계좌이체 결제사용</label></th>
            <td>
        ...
        <tr>
            <th><label for="de_vbank_use">가상계좌 결제사용</label></th>
            <td colspan="3">
...
<section id="frm_delivery_info" class="cbox">
    <h2 >배송정보</h2>
...
<section id="frm_etc_info" class="cbox">
    <h2>기타정보</h2>
...
<section id="frm_sms_info" class="cbox">
    <h2>SMS정보</h2>
    <?=$pg_anchor?>
    ...
    <colgroup>
        ...
        <tr>
          ...
          <td style="text-align:center">
                <table>
                    <tr>
                        <td style="text-align:center"><b><?=$sms_title[$i]?></b></td>
                    </tr>
                    <tr>
                        <td style="text-align:center">(<?=$sms_daesang[$i]?>)</td>
                    </tr>
                    </table><br>

                    <table style="background:url(./img/sms_back.gif)">

                    <tr>
                        <td style="text-align:center">
                            <textarea cols="16" rows="6" id="de_sms_cont<?=$i?>" name="de_sms_cont<?=$i?>" ONKEYUP="byte_check('de_sms_cont<?=$i?>', 'byte<?=$i?>');" style="OVERFLOW: hidden; border:solid 0; width: 100px; background-color:#C4FFFF; FONT-SIZE: 9pt; font-family:굴림체"><?=$default["de_sms_cont".$i]?></textarea>
                        </td>
                    </tr>
                </table>
                <table>
                    <tr>
                        <td style="text-align:center">
                            <div id="byte<?=$i?>" style="text-align:center">0 / 80 바이트</div>
