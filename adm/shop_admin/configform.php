    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                ...
                <label for="de_rel_list_row">출력할 줄 수</label>
                <input type="text" name="de_rel_list_row" value="<?php echo $default['de_rel_list_row']; ?>" id="de_rel_list_row" class="frm_input" size="3">
