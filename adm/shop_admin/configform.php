...
<form name="fconfig" method="post" action="./configformupdate.php" onsubmit="return fconfig_check(this)" enctype="MULTIPART/FORM-DATA">
...
<section id="frm_info" class="cbox">
    ...
    <tbody>
    <tr>
        <th scope="row"><label for="de_admin_company_name">회사명</a></th>
        <td>
...
<tr class=ht>
    <td>대표자명</td>
    <td colspan=3>
        <input type=text name=de_admin_company_owner value='<?=$default['de_admin_company_owner']?>' size=30>
    </td>
</tr>
<tr class=ht>
    <td>대표전화번호</td>
    <td>
        <input type=text name=de_admin_company_tel value='<?=$default['de_admin_company_tel']?>' size=30>
    </td>
    <td>팩스번호</td>
    <td>
        <input type=text name=de_admin_company_fax value='<?=$default['de_admin_company_fax']?>' size=30>
    </td>
</tr>
<tr class=ht>
    <td>통신판매업 신고번호</td>
    <td>
        <input type=text name=de_admin_tongsin_no value='<?=$default['de_admin_tongsin_no']?>' size=30>
    </td>
    <td>부가통신 사업자번호</td>
    <td>
        <input type=text name=de_admin_buga_no value='<?=$default['de_admin_buga_no']?>' size=30>
    </td>
</tr>
<tr class=ht>
    <td>사업장우편번호</td>
    <td>
        <input type=text name=de_admin_company_zip value='<?=$default['de_admin_company_zip']?>' size=10>
    </td>
    <td>사업장주소</td>
    <td>
        <input type=text name=de_admin_company_addr value='<?=$default['de_admin_company_addr']?>' size=30>
    </td>
</tr>
<tr class=ht>
    <td>정보관리책임자명</td>
    <td>
        <input type=text name=de_admin_info_name value='<?=$default['de_admin_info_name']?>' size=30>
    </td>
    <td>정보책임자 e-mail</td>
    <td>
        <input type=text name=de_admin_info_email value='<?=$default['de_admin_info_email']?>' size=30>
     </td>
</tr>
...
<tr class=ht>
    ...
    <td>
        ...
        , 1라인이미지수 : <input type=text name=de_type1_list_mod value='<?=$default['de_type1_list_mod']?>' size=3>
        , 라인 : <input type=text name=de_type1_list_row value='<?=$default['de_type1_list_row']?>' size=3>
        , 폭 : <input type=text name=de_type1_img_width value='<?=$default['de_type1_img_width']?>' size=3>
        , 높이 : <input type=text name=de_type1_img_height value='<?=$default['de_type1_img_height']?>' size=3>
...
<tr class=ht>
    ...
    <td>
        ...
        , 1라인이미지수 : <input type=text name=de_type2_list_mod value='<?=$default['de_type2_list_mod']?>' size=3>
        , 라인 : <input type=text name=de_type2_list_row value='<?=$default['de_type2_list_row']?>' size=3>
        , 폭 : <input type=text name=de_type2_img_width value='<?=$default['de_type2_img_width']?>' size=3>
        , 높이 : <input type=text name=de_type2_img_height value='<?=$default['de_type2_img_height']?>' size=3>
    </td>
</tr>
<tr class=ht>
    <td>최신상품출력</td>
    <td>
        ...
        , 1라인이미지수 : <input type=text name=de_type3_list_mod value='<?=$default['de_type3_list_mod']?>' size=3>
        , 라인 : <input type=text name=de_type3_list_row value='<?=$default['de_type3_list_row']?>' size=3>
        , 폭 : <input type=text name=de_type3_img_width value='<?=$default['de_type3_img_width']?>' size=3>
        , 높이 : <input type=text name=de_type3_img_height value='<?=$default['de_type3_img_height']?>' size=3>
    </td>
</tr>
<tr class=ht>
    <td>인기상품출력</td>
    <td>
        ...
        , 1라인이미지수 : <input type=text name=de_type4_list_mod value='<?=$default['de_type4_list_mod']?>' size=3>
        , 라인 : <input type=text name=de_type4_list_row value='<?=$default['de_type4_list_row']?>' size=3>
        , 폭 : <input type=text name=de_type4_img_width value='<?=$default['de_type4_img_width']?>' size=3>
        , 높이 : <input type=text name=de_type4_img_height value='<?=$default['de_type4_img_height']?>' size=3>
    </td>
</tr>
<tr class=ht>
    <td>할인상품출력</td>
    <td>
        ...
        , 1라인이미지수 : <input type=text name=de_type5_list_mod value='<?=$default['de_type5_list_mod']?>' size=3>
        , 라인 : <input type=text name=de_type5_list_row value='<?=$default['de_type5_list_row']?>' size=3>
        , 폭 : <input type=text name=de_type5_img_width value='<?=$default['de_type5_img_width']?>' size=3>
        , 높이 : <input type=text name=de_type5_img_height value='<?=$default['de_type5_img_height']?>' size=3>
    </td>
</tr>
<tr><td colspan=4 height=1 bgcolor=#CCCCCC></td></tr>
</table>
...
<tr class=ht>
    ...
    <td rowspan=2>
        <textarea name=de_bank_account rows=3 style='width:99%;'><?=$default['de_bank_account']?></textarea>
    </td>
</tr>
<tr class=ht>
    <td>계좌이체 결제사용</td>
...
<tr class=ht>
    ...
    <td>카드결제최소금액</td>
    <td>
        <input type=text name=de_card_max_amount value='<?=$default['de_card_max_amount']?>' size=10> 원
...
<tr class=ht>
    <td>포인트 결제사용</td>
    <td>
        <input type=text name=de_point_settle value='<?=$default['de_point_settle']?>' size=10> 점
...
<tr class=ht>
    ...
    <td>주문완료 포인트</td>
    <td>
        주문 완료 <input type=text name=de_point_days value='<?=$default['de_point_days']?>' size=5> 일 이후에 포인트를 부여
...
<tr class=ht>
    ...
    <td>
        ...
        <span style="font:bold 15px Verdana;">SR</span> <input type=text name=de_kcp_mid value='<?=$default['de_kcp_mid']?>' size=2 maxlength=3 style="font:bold 15px Verdana;"> 영대문자, 숫자 혼용 3자리
    ...
    <td>KCP SITE KEY</td>
    <td><input type=text name=de_kcp_site_key value='<?=$default['de_kcp_site_key']?>' size=32 maxlength=25>
...
<tr class=ht>
    <td>배송비상한가</td>
    <td colspan=3>
        <input type=text name=de_send_cost_limit value='<?=$default['de_send_cost_limit']?>' size=40> 원
...
<tr class=ht>
    <td>배송비</td>
    <td colspan=3>
        <input type=text name=de_send_cost_list value='<?=$default['de_send_cost_list']?>' size=40> 원
    </td>
</tr>
<tr class=ht>
    <td>희망배송일사용</td>
    ...
    <td>희망배송일날짜</td>
    <td>
        <input type=text name=de_hope_date_after value='<?=$default['de_hope_date_after']?>' size=5> 일
...
<tr class=ht>
    <td>관련상품출력</td>
    <td colspan=3>
        1라인이미지수 : <input type=text name=de_rel_list_mod value='<?=$default['de_rel_list_mod']?>' size=3>
        , 이미지폭 : <input type=text name=de_rel_img_width value='<?=$default['de_rel_img_width']?>' size=3>
        , 이미지높이 : <input type=text name=de_rel_img_height value='<?=$default['de_rel_img_height']?>' size=3>
...
<tr class=ht>
    <td>이미지(소) 폭</td>
    <td>
        <input type=text name=de_simg_width value='<?=$default['de_simg_width']?>' size=5> 픽셀
        <?=help("상품관리의 상품입력에서 이미지(대) 입력으로 자동생성해 줄때 이미지(소)의 폭과 높이를 설정한 값으로 생성하여 줍니다.");?>
    </td>
    <td>이미지(소) 높이</td>
    <td>
        <input type=text name=de_simg_height value='<?=$default['de_simg_height']?>' size=5> 픽셀
    </td>
</tr>
<tr class=ht>
    <td>이미지(중) 폭</td>
    <td>
        <input type=text name=de_mimg_width value='<?=$default['de_mimg_width']?>' size=5> 픽셀
        <?=help("상품관리의 상품입력에서 이미지(대) 입력으로 자동생성해 줄때 이미지(중)의 폭과 높이를 설정한 값으로 생성하여 줍니다.");?>
    </td>
    <td>이미지(중) 높이</td>
    <td>
        <input type=text name=de_mimg_height value='<?=$default['de_mimg_height']?>' size=5> 픽셀
    </td>
</tr>
<tr class=ht>
    <td>로고이미지</td>
    <td colspan=3>
        <input type=file name=logo_img size=40>
        <?
...
<tr class=ht>
    <td>메인이미지</td>
    <td colspan=3>
        <input type=file name=main_img size=40>
        <?
...
<tr class=ht>
    ...
    <td>프로그램 등록번호</td>
    <td>
        <input type=text name=de_register value='<?=$default['de_register']?>' size=30 required itemname="프로그램 등록번호">
...
<tr class=ht>
    <td>관리자 핸드폰번호</td>
    <td colspan=3>
        <input type=text name=de_sms_hp value='<?=$default['de_sms_hp']?>' size=20>
...
<tr class=ht>
    <td>아이코드 회원아이디</td>
    <td colspan=3>
        <input type=text name=de_icode_id value='<?=$default['de_icode_id']?>' size=20>
...
<tr class=ht>
    <td>아이코드 패스워드</td>
    <td colspan=3>
        <input type=password name=de_icode_pw value='<?=$default['de_icode_pw']?>'>
